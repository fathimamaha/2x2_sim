...
import sys
import os
# Add the path to the larndsim module
larndsim_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'larndsim'))
print(larndsim_path)
sys.path.append(larndsim_path)
