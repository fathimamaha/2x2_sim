...
#  export LD_LIBRARY_PATH=$GENIE/lib:$DK2NU/lib:$LD_LIBRARY_PATH
...
# gevdump -f /lcrc/project/LCRC_for_DUNE/users/fathima/2x2_sim/run-edep-sim/output/test_MiniRun3.nu/GENIE/test_MiniRun3.nu.00000.0.ghep.root --event-record-print-level 13
